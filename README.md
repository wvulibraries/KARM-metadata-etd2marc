...
Each time the script is run, the variables should be updated to reflect the current semester and the dates that the ETDs were uploaded to the repository. 
